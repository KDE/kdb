...
#define mysqlDebug(...) qCDebug(KDB_MYSQLDRIVER_LOG, __VA_ARGS__)

//! Warning command for the driver
#define mysqlWarning(...) qCWarning(KDB_MYSQLDRIVER_LOG, __VA_ARGS__)

//! Critical command for the driver
#define mysqlCritical(...) qCCritical(KDB_MYSQLDRIVER_LOG, __VA_ARGS__)
