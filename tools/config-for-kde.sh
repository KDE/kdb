...
cmd="cmake ${SOURCE_DIR} -DCMAKE_BUILD_TYPE=DebugFull -DCMAKE_INSTALL_PREFIX=$PREDICATE_INSTALL_PREFIX \
    -DLIB_INSTALL_DIR=$PREDICATE_INSTALL_PREFIX/$_libdir -DPLUGIN_INSTALL_DIR=$PREDICATE_INSTALL_PREFIX/$_libdir/kde4/plugins \
