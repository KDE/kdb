...
#  3. {predicate-source-dir}/tools/config-for-local.sh {predicate-source-dir}
#
# "Dry run" mode:
...
cmd="cmake $1 -DCMAKE_BUILD_TYPE=DebugFull -DCMAKE_INSTALL_PREFIX=$PREDICATE_INSTALL_PREFIX \
